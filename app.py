...
restaurante_mexicano.receber_avaliacao('Damaceno', 7)
restaurante_mexicano.receber_avaliacao('Jucileia', 6)
restaurante_mexicano.receber_avaliacao('Ademir', 2)

restaurante_japones.receber_avaliacao('Benicio', 9)
restaurante_japones.receber_avaliacao('Keit', 7.5)
restaurante_japones.receber_avaliacao('julia', 9.3)
